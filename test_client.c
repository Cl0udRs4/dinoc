...
int main(int argc, char** argv) {
    ...
    printf("Testing protocol switching functionality...\n");
    
    // Test protocol switching
    printf("Current protocol: %d\n", current_protocol);
    
    // Try switching to DNS protocol
    printf("Switching to DNS protocol...\n");
    if (client_switch_protocol(PROTOCOL_DNS) != 0) {
        fprintf(stderr, "Failed to switch to DNS protocol\n");
    } else {
        printf("Successfully switched to DNS protocol\n");
        printf("Current protocol: %d\n", current_protocol);
    }
    
    // Try switching back to TCP protocol
    printf("Switching back to TCP protocol...\n");
    if (client_switch_protocol(PROTOCOL_TCP) != 0) {
        fprintf(stderr, "Failed to switch to TCP protocol\n");
    } else {
        printf("Successfully switched to TCP protocol\n");
        printf("Current protocol: %d\n", current_protocol);
    }
    
    // Try connecting with current protocol
    printf("Connecting with current protocol...\n");
    if (client_connect() != 0) {
    ...
    printf("Protocol switching test completed\n");
    return 0;
}
